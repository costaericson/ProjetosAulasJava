...
//		Produto p1 = new Produto();
		...
		System.out.println("Escreva o nome, preço e quantidade de itens deseja adicionar: ");
		String nome = in.next();
		double preco = in.nextDouble();
		int quantidade = in.nextInt();
		Produto p1 =new Produto(nome, preco, quantidade);

		System.out.printf("Informaçãoe: %s, R$ %.2f, %d unidades, Total: %.2f \n" + p1);
		...
		System.out.printf("Informaçãoe Atualizadas: %s, R$ %.2f, %d unidades, Total: %.2f \n", p1.nome, p1.preco,
